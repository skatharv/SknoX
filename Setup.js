...
function Setup() {
    ...
    return (<div>
        ...
        <div className="App App-header" style={{ color: "white" }}>
            <div style={{width: "66%", height: "90vh" }}>
                ...
                <h1 className="mt-5" style={{ textAlign: "center", fontSize: "1.7rem" }}>Made By iSkillz0 🦐</h1>
            </div>
            <h1 className="mt-5" style={{ textAlign: "center", fontSize: "1.7rem" }}> </h1>
        </div>
    </div>
