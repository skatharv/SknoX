  ...
  return (
    <div style={{ height: "100%" }}>
      ...
      <Dialog open={showMobileDialog}>
        ...
        <DialogContent>
          SknoX Cloud is not currently not supported on mobile devices. Please use a desktop device instead.
        </DialogContent>
        <DialogActions>
      ...
      <div className="App App-header">
        ...
        <div style={{ textAlign: "left", width: "100%", display: "flex", justifyContent: "center" }}>
        ...
        <h1 className="mt-1" style={{ textAlign: "center", fontSize: "1.7rem" }}>Made By iSkillz0 🦐</h1>
        <h1 className="mt-1" style={{ textAlign: "center", fontSize: "4rem" }}></h1>
      </div>
    </div>
  );
}
